...
{
    // Note, the order of middleware in the pipeline is important. The StatusCodePagesMiddleware should
    // be one of the earliest middleware in the pipeline, as it can only modify the response of
    // middleware that comes after it in the pipeline
